...
public class _01_QuizGame {
	...
	public static void main(String[] args) {
		...
		// 제임스 고슬링 (자바 창시자) / 빌게이츠 / 스티브잡스 / 리누즈 토발즈 (리눅스 창시자)
		
		String[] answers = {"제임스 고슬링","빌게이츠","스티브잡스","리누즈 토발즈"}; // 배열선언
		List<String> answerList = Arrays.asList(answers); // 배열을 리스트로 변환
		// List : 크기를 유동적으로 조절할 수 있는 자료구조이다. 리스트로 변환하면 정렬,섞기,추가,삭제 등 자유롭게 가능
		
		Collections.shuffle(answerList); // 섞기
